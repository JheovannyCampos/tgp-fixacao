...
const Inserts = () => {
  return (
    <div className="w-full bg-[#f1f5f9] flex">
      <div className="w-[50%] py-12 flex flex-col justify-center pl-12">
      ...
      <div className="w-[50%] h-full flex flex-col gap-6 justify-end py-12 pr-12">
